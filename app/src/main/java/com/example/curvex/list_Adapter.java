...
public class list_Adapter extends ArrayAdapter {
    ...
    public list_Adapter(Activity mContext, List<c_class> hlist){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        c_class cinfo = hlist.get(position);

        iname.setText(cinfo.getInput());
        c1name.setText(cinfo.getCountry1());
        c2name.setText(cinfo.getCountry2());
